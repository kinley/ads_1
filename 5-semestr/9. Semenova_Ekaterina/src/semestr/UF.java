...
public class UF {
    ...
    /**
     * Читает целочисленное<tt> N </ tt> и последовательность пар целых чисел (между <tt> 0 </ tt> и <tt> N-1 </ TT>) 
     * из стандартного ввода, где каждое целое в паре представляет какой-либо узел; 
     * если узлы находятся в разных компонентах, объединить два компонента и вывести пару в стандартный вывод.
     */
